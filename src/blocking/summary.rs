...
use crate::machine::{Move, State, Symbol};
...
impl BlockSummary {
    ...
    pub fn into_configuration(
        ...
        for tape_id in 1..num_tapes {
            ...
            let tape_contents =
                self.movement_log
                    .replay_full_tape(tape_id, entry_head_pos, blank_symbol);
...
mod tests {
    ...
    fn test_block_summary_size() {
        ...
        assert!(
            space >= b,
            "Space usage should be at least b={} operations",
            b
        );
